...
April 4, 2026 & Luna Aljammal & Addressed final TA feedback \\
\bottomrule
\end{tabularx}
\end{table}
...
Table \ref{tab:fmea-risk-mitigation} summarizes the main failure modes identified for VoiceBridge, their likely effects and causes, the mitigation approach, and the corresponding requirement references.
...
\label{tab:fmea-risk-mitigation}
...
This appendix records the team’s reflection on preparing the hazard analysis, including what worked well, what was difficult, and which new risks became clearer during the process.
