...
\hline
2 & \textbf{Setup:} Select frameworks (\href{https://pytorch.org}{PyTorch}, \href{https://huggingface.co}{Hugging Face}). Collect small impaired-speech dataset (e.g., \href{https://speechaccessibilityproject.beckman.illinois.edu/}{SAP}, \href{https://www.cs.toronto.edu/~complingweb/data/TORGO/torgo.html}{TORGO}, or synthetic augmentations). Define evaluation \textbf{metrics} (WER, CER). \\
\hline
...
\hline
4 & \textbf{Adaptation Phase 1:} Fine-tune selected model on subset of impaired speech data using transfer learning. Consider using LoRA (Low-Rank Adaptation) for efficient fine-tuning. Track overfitting and improvements. \\
\hline
...
\subsection{Technical Details (10.1)}
...
\subsection{Risks \& Alternative Paths (10.2)}
...
We plan to use \textbf{PyTorch} or \textbf{TensorFlow} for model fine-tuning. 
