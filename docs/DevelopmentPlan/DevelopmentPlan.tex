...
Our team is adopting the MIT License for this project. 
The license file is included in our repository 
(\href{run:VoiceBridge/LICENSE}{\texttt{LICENSE}} file\footnote{\texttt{VoiceBridge/LICENSE}}).
