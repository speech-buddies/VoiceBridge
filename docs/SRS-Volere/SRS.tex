...
\subsection{Access Requirements}\label{subsec:access}

\textbf{SEC1: Role-Based Access Control}\label{req:SEC1}
...
\subsection{Integrity Requirements}\label{subsec:integrity}

\textbf{SEC2: Command Integrity Validation}\label{req:SEC2}
...
\subsection{Privacy Requirements}\label{subsec:privacy}

\textbf{SEC3: User Data Privacy Protection}\label{req:SEC3}
...
\subsection{Audit Requirements}\label{subsec:audit}

\textbf{SEC4: Secure Audit Logging}\label{req:SEC4}
...
\subsection{Immunity Requirements}\label{subsec:immunity}

\textbf{SEC5: Resilience to Misuse}\label{req:SEC5}
