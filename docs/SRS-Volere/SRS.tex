...
\begin{itemize}
    ...
    \item \textbf{David}, a stroke survivor, uses the system to browse the web and make purchases. His voice is described by pathologist as having slurred and distorted consonants, as well as being monopitch, distorting his speech. 
\end{itemize}
