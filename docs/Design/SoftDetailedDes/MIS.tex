...
\begin{itemize}
  ...
  \item Error Feedback (M8) for reporting processing failures.
  \item AuditLogger (M14) for logging processing events and errors.
...
\newpage
\section{(M5) MIS of Intent Interpreter}
\label{M5}
...
\newpage
\section{(M6) MIS of Command Mapping Module}
\label{M6}
