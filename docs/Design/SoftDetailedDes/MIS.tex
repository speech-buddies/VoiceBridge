...
\progname, the VoiceBridge system.
...
\noindent
In addition to these primitive types, \progname\ uses several derived types relevant
...
\noindent
Functions used by \progname\ are typed by input and output domains.  
