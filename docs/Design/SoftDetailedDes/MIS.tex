...
\newpage
\section{(M4) MIS Speech-to-Text Engine}
\label{M4}
...
\begin{itemize}
  ...
  \item User Profile Manager (M10) for personalized context and preferences.
  \item Error Feedback Module (M8) for reporting API or schema validation failures.
  \item Security Layer (M12) for managing API credentials and encryption.
\end{itemize}
...
\newpage
\section{(M7) MIS of Command Execution Layer} \label{M7}
...
\section{(M8) MIS of Error Feedback} \label{M8}
...
\section{(M9) MIS of BrowserController} \label{M9}
...
\section{(M10) MIS of Session Manager} \label{M10}
...
% \end{itemize}
\section{(M11) MIS of Error Handling \& Recovery Module} \label{M11}
...
\section{(M12) MIS of Data Management Module}\label{M12}
...
\section{(M13) MIS of User Profile Manager} \label{M13}
...
\section{(M14) MIS of AuditLogger} \label{M14}
...
\section{(M15) MIS of Credential Manager} \label{M15}
...
\section{(M16) MIS of Encryption Manager} \label{M16}
...
\section{(M17) MIS of OutOfScopeHandler}\label{M17}
...
\section{(M18) MIS of MicrophoneManager} \label{M18}
...
\section{(M19) MIS of VADNoiseFilter} \label{M19}
...
\section{(M20) MIS of PromptingModule} \label{M20}
...
\section{(M21) MIS of ModelTuner} \label{M21}
...
\section{(M22) MIS of InstructionRegistry} \label{M22}
