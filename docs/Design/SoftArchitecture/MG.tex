...
\begin{itemize}
  ...
  \item Accessibility Layer
  \item Feedback Display Module
  \item Speech-to-Text Engine
  \item Command Orchestrator
  \item Error Feedback
  \item Browser Orchestrator
  \item Session Manager
  \item Data Management Layer
  \item User Profile Manager
  \item Audit Logger
  \item Credential Manager
  \item Encryption Manager
  \item Out-of-Scope Handler
  \item Microphone Manager
  \item VAD Noise Filter
  \item Prompting Module
  \item Model Tuner
\end{itemize}
...
\subsubsection*{M15: Microphone Manager} \refstepcounter{mnum}\mthemnum\label{m15}
\textbf{Secrets:} 
\begin{itemize}
...
\medskip
\subsubsection*{M16: VAD Noise Filter} \refstepcounter{mnum}\mthemnum\label{m16}
\textbf{Secrets:} 
\begin{itemize}
