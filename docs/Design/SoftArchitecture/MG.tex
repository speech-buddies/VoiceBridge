...
\subsection{Module Completion Schedule}
The following table outlines the completion schedule for each module, listed in chronological order. Each team member is assigned a module for every deadline, ensuring balanced contributions. While collaboration occurred across all modules, the listed members were responsible for assembling the final components of each module.
...
\noindent
The schedule helps balance the workload across the team and keeps the project moving forward at a steady pace. Team members will work together and review each other’s work throughout development to ensure consistency and quality. Collaboration and peer reviews will continue throughout the process to maintain high standards and alignment with project goals.
\medskip
\noindent
