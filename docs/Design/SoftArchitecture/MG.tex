...
\textbf{Secrets:} 
\begin{itemize}
  \item Message templating and localization hooks
  \item Mapping of internal error classes to user-facing copy and recovery options
\end{itemize}
\textbf{Services:} 
\begin{itemize}
  \item Show error messages
  \item Show recovery prompts with options
  \item Dismiss items
  \item Log events
\end{itemize}
