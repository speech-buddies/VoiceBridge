...
\textbf{Secrets:} 
\begin{itemize}
  \item Audio device configuration and sampling parameters (sample rate, channels, chunk size)
  \item WebRTC VAD integration and aggressiveness levels (0--3)
  \item Hybrid speech detection combining VAD and optional energy thresholds
  \item State machine logic (IDLE, LISTENING, SPEECH\_DETECTED, RECORDING, PROCESSING, STOPPED)
  \item Pre-buffering mechanism to capture audio before speech detection
  \item Silence detection thresholds and automatic recording termination
  \item Audio format conversion between int16 (for VAD) and float32 (for output)
  \item Stream management and threading strategy for continuous capture
\end{itemize}
\textbf{Services:} 
\begin{itemize}
  \item Configure audio parameters via \texttt{AudioConfig} (sample rate, VAD aggressiveness, buffer durations, silence thresholds)
  \item Start and stop continuous audio stream with state management
  \item Detect speech frames vs. silence using WebRTC VAD
  \item Optionally apply energy-based speech detection as secondary criterion
  \item Automatically trigger recording on speech detection with pre-buffered audio
  \item End recording after configurable silence duration (default 1500ms) or maximum duration (default 30s)
  \item Emit complete audio recordings as float32 arrays with metadata (duration, sample count, timestamp)
  \item List available audio input devices
  \item Provide capture statistics (total recordings, audio duration, VAD errors, stream errors)
\end{itemize}
\textbf{Implemented By:} \texttt{audio\_capture.py} using sounddevice and webrtcvad libraries.
...
\midrule
\frref{fr:FR1}& \mref{m15}, \mref{m4}, \mref{m8}\\
\frref{fr:FR2}& \mref{m4}, \mref{m18}, \mref{m9}\\
\frref{fr:FR3}& \mref{m1}, \mref{m2}, \mref{m3}, \mref{m6}\\
\frref{fr:FR4}& \mref{m5}, \mref{m6}\\
\frref{fr:FR5}& \mref{m7}, \mref{m7}, \mref{m11}, \mref{m6}\\
\bottomrule
\end{tabular}
...
\textbf{Req.} & \textbf{Modules}\\
\midrule
\lfref{req:AR1}& \mref{m1}, \mref{m2}, \mref{m3}, \mref{m6}\\
\lfref{req:SR1}& \mref{m1}, \mref{m2}, \mref{m17}, \mref{m3}\\
\bottomrule
\end{tabular}
...
\textbf{Req.} & \textbf{Modules}\\
\midrule
\uhref{req:EU1}& \mref{m1}, \mref{m2}, \mref{m3}, \mref{m6}\\
\uhref{req:PI1}& \mref{m10}, \mref{m9}, \mref{m5}, \mref{m6}\\
\uhref{req:LR1}& \mref{m1}, \mref{m2}, \mref{m17}, \mref{m8}\\
\uhref{req:UP1}& \mref{m6}, \mref{m3}, \mref{m2}, \mref{m17}\\
\uhref{req:AC1}& \mref{m2}, \mref{m1}, \mref{m3}, \mref{m6}\\
\bottomrule
\end{tabular}
...
\textbf{Req.} & \textbf{Modules}\\
\midrule
\pfref{req:PR1}& \mref{m4}, \mref{m5}, \mref{m6}, \mref{m7}, \mref{m7}\\
\pfref{req:PR2}& \mref{m5}, \mref{m6}, \mref{m7}, \mref{m6}, \mref{m11}\\
\pfref{req:PR3}& \mref{m4}, \mref{m18}, \mref{m5}\\
\pfref{req:PR4}& \mref{m11}, \mref{m8}, \mref{m6}, \mref{m7}\\
\pfref{req:PR5}& \mref{m8}, \mref{m9}, \mref{m10}\\
\pfref{req:PR6}& \mref{m8}, \mref{m9}, \mref{m7}\\
\pfref{req:PR7}& \mref{m9}, \mref{m10}, \mref{m11}, \mref{m12}\\
\bottomrule
\end{tabular}
...
\textbf{Req.} & \textbf{Modules}\\
\midrule
\oerref{req:OE1}& \mref{m15}, \mref{m4}, \mref{m11}\\
\oerref{req:OE2}& \mref{m1}, \mref{m2}, \mref{m7}, \mref{m8}\\
\oerref{req:OE3}& \mref{m5}, \mref{m6}, \mref{m7}\\
\oerref{req:OE4}& \mref{m9}, \mref{m10}, \mref{m11}, \mref{m12}, \mref{m8}\\
\oerref{req:OE5}& \mref{m8}, \mref{m9}, \mref{m11}, \mref{m12}\\
\bottomrule
\end{tabular}
...
\textbf{Req.} & \textbf{Modules}\\
\midrule
\msref{req:MS1}& \mref{m8}, \mref{m9}, \mref{m10}, \mref{m11}, \mref{m12}\\
\msref{req:MS2}& \mref{m1}, \mref{m2}, \mref{m3}, \mref{m6}, \mref{m17}\\
\msref{req:MS3}& \mref{m1}, \mref{m2}, \mref{m7}, \mref{m8}, \mref{m11}\\
\bottomrule
\end{tabular}
...
\textbf{Req.} & \textbf{Modules}\\
\midrule
\secref{req:SEC1}& \mref{m12}, \mref{m13}, \mref{m10}, \mref{m9}, \mref{m8}\\
\secref{req:SEC2}& \mref{m5}, \mref{m6}, \mref{m7}, \mref{m6}, \mref{m11}\\
\secref{req:SEC3}& \mref{m9}, \mref{m10}, \mref{m11}, \mref{m12}, \mref{m13}\\
\secref{req:SEC4}& \mref{m11}, \mref{m9}, \mref{m8}, \mref{m12}\\
\secref{req:SEC5}& \mref{m11}, \mref{m6}, \mref{m7}, \mref{m7}\\
\bottomrule
\end{tabular}
...
\textbf{Req.} & \textbf{Modules}\\
\midrule
\culref{req:CR1}& \mref{m2}, \mref{m3}, \mref{m6}, \mref{m17}, \mref{m5}\\
\bottomrule
\end{tabular}
...
\textbf{Req.} & \textbf{Modules}\\
\midrule
\cplref{req:CO1}& \mref{m9}, \mref{m10}, \mref{m11}, \mref{m12}, \mref{m13}\\
\cplref{req:CO2}& \mref{m1}, \mref{m2}, \mref{m3}, \mref{m6}\\
\bottomrule
\end{tabular}
